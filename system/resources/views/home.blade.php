...
<head>
    ...
    <link rel="stylesheet" href="{{('public')}}/dist/css/camera.css">
    <link rel="stylesheet" href="{{('public')}}/dist/css/jquery.fancybox.css">
    ...
    <header>
        ...
        <div class="camera_container">
            <div id="camera" class="camera_wrap">
                <div data-thumb="{{('public')}}/dist/images/slide01_thumb.jpg" data-src="{{('public')}}/dist/images/slide01.jpg">
                    <div class="camera_caption fadeIn">
                    </div>
                </div>
                <div data-thumb="{{('public')}}/dist/images/slide02_thumb.jpg" data-src="{{('public')}}/dist/images/slide02.jpg">
                    <div class="camera_caption fadeIn">
                    </div>
                </div>
                <div data-thumb="{{('public')}}/dist/images/slide03_thumb.jpg" data-src="{{('public')}}/dist/images/slide03.jpg">
                    <div class="camera_caption fadeIn">
                    </div>
                </div>
            </div>
    ...
    <main>
        <section class="well">
            <div class="container">
                ...
                <div class="row">
                    <div class="grid_6">
                        <div class="img img__border"><div class="lazy-img" style="padding-bottom: 63.0282%;"><img data-src="{{('public')}}/dist/images/page-1_img01.jpg" alt=""></div></div>
                    ...
                    <div class="grid_6">
                        <div class="img img__border"><div class="lazy-img" style="padding-bottom: 63.0282%;"><img data-src="{{('public')}}/dist/images/page-1_img02.jpg" alt=""></div></div>
                        <p class="center indents-1">Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl auctor vel veliterol. sed,pharetra venenatis nulla. Vestibulum volutpat turpis ut massa commodo, quis aliquam massa facilisis.Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl auctor vel veliterol. sed,pharetra venenatis nulla.</p>
                    </div>
                </div>
            ...
            <div class="gallery">
                <div class="gallery_col-1">
                    <a data-fancybox-group="gallery" href="{{('public')}}/dist/images/page-1_img03_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 93.96551724137931%;">
                        <img data-src="{{('public')}}/dist/images/page-1_img03.jpg" alt="">
                    ...
                    <a data-fancybox-group="gallery" href="{{('public')}}/dist/images/page-1_img04_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 74.13793103448276%;">
                        <img data-src="{{('public')}}/dist/images/page-1_img04.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Lorem Blandit</em></p>
                                <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
                    ...
                    <a data-fancybox-group="gallery" href="{{('public')}}/dist/images/page-1_img05_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 94.6551724137931%;">
                        <img data-src="{{('public')}}/dist/images/page-1_img05.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Lorem Blandit</em></p>
                                <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
                ...
                <div class="gallery_col-2">
                    <a data-fancybox-group="gallery" href="{{('public')}}/dist/images/page-1_img06_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 52.48322147651007%;">
                        <img data-src="{{('public')}}/dist/images/page-1_img06.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Lorem Blandit</em></p>
                                <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
                    ...
                    <a data-fancybox-group="gallery" href="{{('public')}}/dist/images/page-1_img07_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 55.97315436241611%;">
                        <img data-src="{{('public')}}/dist/images/page-1_img07.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Lorem Blandit</em></p>
                                <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
                    ...
                    <a data-fancybox-group="gallery" href="{{('public')}}/dist/images/page-1_img08_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 96.10738255033557%;">
                        <img data-src="{{('public')}}/dist/images/page-1_img08.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Lorem Blandit</em></p>
                                <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
                ...
                <div class="gallery_col-3">
                    <a data-fancybox-group="gallery" href="{{('public')}}/dist/images/page-1_img09_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 93.69676320272572%;">
                        <img data-src="{{('public')}}/dist/images/page-1_img09.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Lorem Blandit</em></p>
                                <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
                    ...
                    <a data-fancybox-group="gallery" href="{{('public')}}/dist/images/page-1_img10_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 72.23168654173765%;">
                        <img data-src="{{('public')}}/dist/images/page-1_img10.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Lorem Blandit</em></p>
                                <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
                    ...
                    <a data-fancybox-group="gallery" href="{{('public')}}/dist/images/page-1_img11_original.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 93.69676320272572%;">
                        <img data-src="{{('public')}}/dist/images/page-1_img11.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Lorem Blandit</em></p>
                                <p>Integer convallis orci vel mi nelaoreet, at ornare lorem consequat. Phasellus era nisl</p>
        ...
        <section class="well well__offset-1 bg-1">
            <div class="container">
                ...
                <div class="row row__offset-1">
                    <div class="grid_4">
                        <figure>
                            <div class="img lazy-img" style="padding-bottom: 101.0810810810811%;"><img data-src="{{('public')}}/dist/images/page-1_img12.jpg" alt=""></div>
                    ...
                    <div class="grid_4">
                        <figure>
                            <div class="img lazy-img" style="padding-bottom: 101.0810810810811%;"><img data-src="{{('public')}}/dist/images/page-1_img13.jpg" alt=""></div>
                    ...
                    <div class="grid_4">
                        <figure>
                            <div class="img lazy-img" style="padding-bottom: 101.0810810810811%;"><img data-src="{{('public')}}/dist/images/page-1_img14.jpg" alt=""></div>
